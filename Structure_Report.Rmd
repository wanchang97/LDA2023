...
```{r}
library(ggplot2)
# To view the mean structure of the respons for all individuals
ggplot(data.long.noNA,aes(x=time,y=HC,group=id))  + geom_line(col="grey")+stat_summary(aes(group=1),geom="line",fun=mean,linewidth=2)
```
