...
this two can be answered from the `data_summary`
...
```{r}
trenal.wide4 = reshape(trenal.long,
                       direction="wide",
                       timevar="time",
                       idvar="id",
                       v.names="HC",
                       sep="_")
trenal.wide1 = trenal[,1:17] # wide table form

trenal.wide2.noNA = reshape(data=trenal.long,
                      direction="wide",
                      v.names=c("HC"),
                      timevar="time",
                      idvar="id")
trenal.wide3.noNA = reshape(data=trenal.long,
                      direction="wide",
                      v.names=c("HC"),
                      timevar="j",
                      idvar="id")

trenal.wide2.noNA = reshape(data=trenal.long.noNA,
                      direction="wide",
                      v.names=c("HC"),
                      timevar="time",
                      idvar="id")
trenal.wide3.noNA = reshape(data=trenal.long.noNA,
                      direction="wide",
                      v.names=c("HC"),
                      timevar="j",
                      idvar="id")
...
#### Response variable
From the `summary(data.long.noNA)`, we can read that the response variable is a continuous variable `HC` HC level from $(15,76)$ with Mean $38.24$.
