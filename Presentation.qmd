...
+Time-level (also called Level One) variables: changed with time, indexed by $j$ e.g. time and response Hc
+Subject-level* (also called Level Two) variables: changed with subjects indexed by $i$ e.g. age, male, reject, cardio
