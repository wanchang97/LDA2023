...
summary(trenal.long)
```
Now, it is interesting to rellocate the variables in order to have a claear format of the data. Moreover, some of the variables are transformed to factor since they are not numerical ones. 
